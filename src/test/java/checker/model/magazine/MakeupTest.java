...
public class MakeupTest {
    ...
    public void shouldReturnDiscountPrice() {
        ...
        String price = makeup.getValue(creator.createDocumentFromFile("xml/makeup/Makeup_discount.xml"));
    ...
    public void shouldReturnNormalPrice() {
        ...
        String price = makeup.getValue(creator.createDocumentFromFile("xml/makeup/Makeup_normal.xml"));
    ...
    public void shouldReturnOutOfStock() {
        ...
        String price = makeup.getValue(creator.createDocumentFromFile("xml/makeup/Makeup_outofstock.xml"));
